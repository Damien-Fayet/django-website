...
urlpatterns = [
    ...
    # Ajout de livres (flux simplifié)
    ...
    # Actions AJAX pour améliorer l'UX
    path('ajax/recherche/', views.ajax_search, name='ajax_search'),
    path('ajax/noter/', views.ajax_rate_book, name='ajax_rate_book'),
    
    # Actions en lot
    path('actions-lot/', views.bulk_actions, name='bulk_actions'),
]
